    ...
    return (
        ...
        <div className={style.main}>
            <div data-aos="fade-right"  className={style.image1} > 
                ...
                <Image alt=" " src="/landing/first.jfif" fill style={{objectFit:'cover',borderRadius:"8px"}}   ></Image>
            </div>
            <div data-aos="fade-left"  className={style.image2} >
                ...
                <Image alt=" " src={"/landing/second.png"}  style={{objectFit:'cover',borderRadius:"8px"}} fill></Image>
            </div>
        </div>
        </AOSComponent>
    )
