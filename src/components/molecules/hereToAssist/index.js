    ...
    return ( 
        <div className={style.main}>
            <div className={style.main2}>
                ...
                {StatesList.map( (e,key)=><Button key={key} content={e} backgroundColor={"white"} width={"90%"} btnClass={2} className={style["grid-item"]} borderthick={"2px solid rgba(121, 117, 114, 1)"} fontColor={"rgba(121, 117, 114, 1)"} href={"/services/getFurniture/"+e} ></Button>)}
                </div>
