    ...
    return ( 
        <div className={style.main}>
                <div className={style.image}>
                        <Image alt=" "  src={"/services/Images2/donate furniture.png"} fill></Image>
                ...
                <div className={style.image}>
                        <Image alt=" "  src={"/services/Images2/donate service.png"} fill></Image>
                        {/* <div className={style.imageCont}></div> */}
                ...
                <div className={style.image}>
                        <Image alt=" "  src={"/services/Images2/donate money.png"} fill></Image>
                        {/* <div className={style.imageCont}></div> */}
