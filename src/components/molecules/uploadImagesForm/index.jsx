        ...
        <div>
            {!submitted ? (
                ...
                >
                    <div className={style.left}>
                        <div className={style.imageUpload}>
                            {file && <Image src={previewUrl} className={style.imageInside} fill />}
                            <label htmlFor="files" className={style.inputs123}>
                        ...
                        <br />
                        {imageUploaded && <h1 className={style.heading}>Image is uploaded</h1>}
                    ...
                    <motion.div className={style.right}>
                        ...
                        <InputField
                            ...
                            name={"exactLocation"}
                        />
                        {errors.exactLocation && <div className={style.error}>{errors.exactLocation}</div>}
                        <InputField
                            onChange={dataSetter}
                            placeholder={"TYPE OF FURNITURE*"}
                            name={"tof"}
