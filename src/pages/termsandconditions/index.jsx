...
const TermsAndConditions = () => {
  return (
    <div className={styles.container}>
      ...
      <br />
      <p>
        Welcome to TDG Furniture Exchange, powered by The Designers Group. By accessing this website, you agree to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern TDG Furniture Exchange's relationship with you in relation to this website. If you disagree with any part of these terms and conditions, please do not use our website.
      </p>
      <p>
        The term 'TDG Furniture Exchange' or 'us' or 'we' refers to the owner of the website. The term 'you' refers to the user or viewer of our website.
      </p>
      <p>
